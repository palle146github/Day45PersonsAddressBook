...
const createInnerHtml = () => {    
    const headerHtml ="<tr><th>Full Name</th><th>Address</th><th>City</th><th>State</th><th>Zip</th><th>Phone Number</th><th>Actions</th></tr>";
    ...
    for( const addressBookData of addressBookList){
        ...
        <td>${addressBookData._citySelect}</td>
        <td>${addressBookData._stateSelect}</td>
        <td>${addressBookData._zip}</td>
        <td>${addressBookData._phone}</td>
        <td><img name="${addressBookData._id}" id="delete" onclick="remove(this)" src="../assets/delete-black-18dp.svg" alt="delete">
        <img name="${addressBookData._id}" id="edit" onclick="update(this)" src="../assets/create-black-18dp.svg" alt="edit"></td>
        </td>
        </tr>
        `;
    }
